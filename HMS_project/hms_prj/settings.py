...
SECRET_KEY = "django-insecure-5(*dchu0cxhv9@ok8vcdayavjl=w#1c%z&s0#%f8#zg2jik_q_"
...
JAZZMIN_SETTINGS = {
    ...
    "copyright": "All Rights Reserved 2026 - Muhammadaziz",
    "welcome_sign": "Welcome to HMS system, Login Now.",
    "topmenu_links": [
